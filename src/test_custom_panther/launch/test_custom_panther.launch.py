...
def generate_launch_description():
    ...
    camera_bridge = Node(
        ...
        arguments=[
            'world/default/model/side_camera/link/link/sensor/camera2/image@sensor_msgs/msg/Image@ignition.msgs.Image',
            'world/default/model/side_camera/link/link/sensor/camera2/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo',
            'world/default/model/top_down_camera/link/link/sensor/camera1/image@sensor_msgs/msg/Image@ignition.msgs.Image',
            'world/default/model/top_down_camera/link/link/sensor/camera1/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo'
        ],
        output='screen'
    )
    ...
    return LaunchDescription(
        [
            AppendEnvironmentVariable(name='GZ_SIM_RESOURCE_PATH', value = PathJoinSubstitution([FindPackageShare(current_package),"world"])),
            declare_world_arg,
            declare_pose_x_arg,
            declare_pose_y_arg,
            declare_pose_z_arg,
